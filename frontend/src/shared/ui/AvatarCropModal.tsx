...
const roundToSix = (value: number) => Math.round(value * ROUND_FACTOR) / ROUND_FACTOR

const toNormalizedCrop = (areaPixels: Area | null, mediaSize: MediaSize | null): AvatarCrop => {
      ...
      <div className={styles.modal} onClick={(event) => event.stopPropagation()}>
        <div className={styles.header}>
          <div>
            ...
            <p className={styles.subtitle}>Перемещайте изображение внутри круглой области.</p>
          </div>
        </div>
        ...
        <div className={styles.actions}>
          ...
          <Button
            variant="primary"
            onClick={() => onApply(toNormalizedCrop(croppedAreaPixelsRef.current, mediaSizeRef.current))}
          >
            Применить
          </Button>
        </div>
